...
<section class="packages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Maldives</h3>
            <p>Maldives has more than 1190 low-lying coral islands that are gathered into 26 atolls, which can be seen in 200 inhabited islands of Maldives along with 80 islands that have tourist resorts. Archipelago enjoy a wonderful location along and across the main sea lines of the Indian Ocean.</p>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         <div class="image">
            <img src="images/Hunstanton.jpg" alt="">
         </div>
         <div class="content">
            <h3>Hunstanton</h3>
            <p>Hunstanton has a fairground, aquarium and seal sanctuary, leisure pool, theatre, large caravan parks with amenities (Searle's Holiday Park opened in 1936), some amusement arcades, and a long promenade. The centrepiece remains the large sloping green from one end of High Street to the promenade.</p>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>contact info</h3>
         <a href="#"> <i class="fas fa-phone"></i> +919573615158 </a>
